...
})({"bOGti":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
window.addEventListener("scroll", ()=>{
    if (window.scrollY > 100) navInner.classList.add("nav__active");
    else navInner.classList.remove("nav__active");
});
const about = [
    {
        title: 'Conquer',
